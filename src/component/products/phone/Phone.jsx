...
import   './../men/Men.css'
import PhoneD from './PhoneD'
import Details from './Details'

const Phone = ({AddProduct}) => {
   //    Start Filter Product 

    const [ProductD, setProductD] = useState(PhoneD)
      ...
      <div className='Container-SideBar'>
            ...
            filteredProducts.map((product,index) => (
                <div className='Products-Show-Info' key={index}>
                    <div className='Products-Show-Img '>
                        <img className='PhoneImg' src={product.img} alt={product.alt}/>
                    </div>
           ...
           : <div className='Products-Show'>
        {
            ProductD.map((item,index)=>{
                ...
                <div className='Products-Show-Info' key={index}>
                    <div className='Products-Show-Img'>
                        <img className='PhoneImg' src={item.img} alt={item.alt}/>
                    </div>
                    <div className='Products-Show-Span'>
